...
const Contact: React.FC<ContactProps> = ({ content }) => {
  ...
  // Structure catering bullets data for mapping
  const cateringBullets = [
    content.cateringBullet1,
    content.cateringBullet2,
    content.cateringBullet3,
    content.cateringBullet4,
    content.cateringBullet5,
  ].filter(Boolean); // Filter out any potentially empty/null bullets
  ...
  return (
    <section id="contact" className="section relative">
      ...
      <div className="container mx-auto relative z-10">
        <SectionTitle
          subtitle={content.contactSectionLabel || "Get In Touch"}
          title={content.contactSectionTitle || "Contact & Catering"}
        />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <div className="space-y-8">
            <div>
              ...
              <p className="text-cochi-brown/90">{content.contactUsText}</p>
            </div>

            <div className="space-y-4">
              <h3 className="text-2xl font-display font-semibold mb-3 text-cochi-brown">
                {content.cateringSubtitle}
              </h3>
              <p className="text-cochi-brown/90">{content.cateringText}</p>
